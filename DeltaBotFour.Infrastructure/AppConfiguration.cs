...
namespace DeltaBotFour.Infrastructure
{
    public class AppConfiguration
    {
        ...
        public string NoSnipeFlairs => _configuration["no_snipe_flairs"];
        ...
        public class DeltaBotReplaceTokens
        {
            ...
            public string NoSnipeFlairs => _configuration["replace_tokens:no_snipe_flairs"];
        ...
        public class DeltaBotComments
        {
            ...
            public string SnipeNotAllowed => _configuration["comments:snipe_not_allowed"];
            ...
            public DeltaBotComments(IConfigurationRoot configuration)
            {
                ...
                AllComments = new List<Tuple<string, DB4CommentType>>
                {
                    ...
                    new Tuple<string, DB4CommentType>(SnipeNotAllowed, DB4CommentType.FailSnipeNotAllowed)
                };
            }
        }
