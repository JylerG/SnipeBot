...
namespace DeltaBotFour.Infrastructure.Implementation
{
    public class DeltaboardEditor : IDeltaboardEditor
    {
        ...
        private const string UpdateDeltaboardsReason = "Update snipeboards";
        ...
        private string buildDeltaboard(Deltaboard deltaboard)
        {
            ...
            {
                deltaboardContent =
                    $"{deltaboardContent}\r\n\r\n*Due to technical limitations, All Time Snipeboards do not count deltas awarded prior to September 2024*";
            }
