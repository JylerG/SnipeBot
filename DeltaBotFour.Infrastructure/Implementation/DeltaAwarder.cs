...
namespace DeltaBotFour.Infrastructure.Implementation
{
    public class DeltaAwarder : IDeltaAwarder
    {
        ...
        public void Award(DB4Thing comment)
        {
            ...
            _logger.Info($"---START AWARD SNIPE--- -> user: {comment.ParentThing.AuthorName}, comment: {comment.Permalink}");
            ...
            if (newDeltaCount == 1)
            {
                ...
                _logger.Info("   ---Sending first snipe PM (award)");
            ...
            // Update deltaboards
            _logger.Info("   ---Updating snipeboards (award)");
            ...
            _logger.Info("   ---Adding snipe to local db (award)");
            ...
            _logger.Info("   ---Updating SnipeLog (award)");
        ...
        public void Unaward(DB4Thing comment)
        {
            ...
            _logger.Info($"---START UNAWARD SNIPE--- -> user: {comment.ParentThing.AuthorName}, comment: {comment.Permalink}");
            ...
            _logger.Info("---END UNAWARD SNIPE---");
        }
    }
}
